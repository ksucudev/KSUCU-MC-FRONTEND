...
export type ChairpersonSection = string;

interface ChairpersonSidebarProps {
  activeSection: ChairpersonSection;
  onSectionChange: (section: ChairpersonSection) => void;
  isOpen: boolean;
  onToggle: () => void;
  onLogout: () => void;
}
...
const ChairpersonSidebar: React.FC<ChairpersonSidebarProps> = ({
  activeSection,
  onSectionChange,
  isOpen,
  onToggle,
  ...
  const handleItemClick = (section: ChairpersonSection) => {
          ...
          <div className={styles.identityBlock}>
            ...
            <div className={styles.identityText}>
              ...
              <span className={styles.roleBadge}>
                <Crown size={10} color="#c9a227" /> Chairperson
              </span>
            </div>
          </div>
