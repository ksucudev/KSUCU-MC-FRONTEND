...
function EditorialBoard() {
  const board = boards.find(b => b.id === 'editorial');
  ...
  const cardData = [
    {
      title: "Notice Board Mgt",
      icon: "fas fa-clipboard",
      desc: "Maintains the Notice Board making sure its always updated.",
      active: false
    },
    {
      title: "Magazine Publishing",
      icon: "fas fa-book-open",
      desc: "Publishes the union weekly magazine to enrich members.",
      active: true
    },
    {
      title: "Publications Editing",
      icon: "fas fa-edit",
      desc: "Carefully reviews and edits articles and publications.",
      active: false
    },
    {
      title: "Content Writing",
      icon: "fas fa-pen-nib",
      desc: "Drafts empowering and spiritual articles for the union.",
      active: false
    }
  ];
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      formData.append('boardId', 'editorial');
    ...
    <div className="ict-board-container">
      <section className="ict-hero-section" style={{ backgroundImage: `url(${boardHeroBg})` }}>
        ...
        <div className="ict-hero-content">
          <div className="ict-hero-subtitle">Writing & Editing</div>
          <h1 className="ict-hero-title">
            <span className="ict-hero-title-highlight">Editorial Board</span>
          </h1>
          <p className="ict-hero-desc">Connecting and Building the Literary Ecosystem for KSUCU-MC</p>
        </div>
      </section>
      ...
      <section className="ict-recruitment-ad">
        <h2>Ignite Your Writing Career with Us!</h2>
        <p>Are you passionate about writing, editing, curating magazines, or managing information boards? The KSUCU-MC Editorial Board is the perfect ecosystem to grow your skills while serving the Lord.</p>
        ...
        {showJoin && (
          <div className="ict-join-info">
            ...
            <ol>
              <li>Write a formal application letter addressed to the Editorial Board Overseer indicating your area of interest.</li>
